...
#region classes
enum MDLFlag {
	AUTOGENERATED_HITBOX 									= 0x0001, 	# binary 0b0000000000000001
	USES_ENV_CUBEMAP 										= 0x0002, 	# binary 0b0000000000000010
	FORCE_OPAQUE 											= 0x0004, 	# binary 0b0000000000000100
	TRANSLUCENT_TWOPASS 									= 0x0008, 	# binary 0b0000000000001000
	STATIC_PROP 											= 0x0010, 	# binary 0b0000000000010000
	USES_FB_TEXTURE 										= 0x0020, 	# binary 0b0000000000100000
	HAS_SHADOWLOD 											= 0x0040, 	# binary 0b0000000001000000
	USES_BUMPMAPPING 										= 0x0080, 	# binary 0b0000000010000000
	USE_SHADOWLOD_MATERIALS 								= 0x0100, 	# binary 0b0000000100000000
	OBSOLETE 												= 0x0200, 	# binary 0b0000001000000000
	UNUSED 													= 0x0400, 	# binary 0b0000010000000000
	NO_FORCED_FADE 											= 0x0800, 	# binary 0b0000100000000000
	FORCE_PHONEME_CROSSFADE 								= 0x1000, 	# binary 0b0001000000000000
	CONSTANT_DIRECTIONAL_LIGHT_DOT 							= 0x2000, 	# binary 0b0010000000000000
	FLEXES_CONVERTED 										= 0x4000, 	# binary 0b0100000000000000
	BUILT_IN_PREVIEW_MODE 									= 0x8000, 	# binary 0b1000000000000000
	AMBIENT_BOOST 											= 0x10000, 	# binary 0b0000000100000000000000
	DO_NOT_CAST_SHADOWS 									= 0x20000, 	# binary 0b0000001000000000000000
	CAST_TEXTURE_SHADOWS 									= 0x40000, 	# binary 0b0000010000000000000000
	NA1 													= 0x80000, 	# binary 0b0000100000000000000000
	NA2 													= 0x100000, # binary 0b0001000000000000000000
	VERT_ANIM_FIXED_POINT_SCALE 							= 0x200000, # binary 0b0010000000000000000000
}
...
var is_static_prop: bool:
	get: return header.flags & MDLFlag.STATIC_PROP != 0;
