...
3. Download [the blank mod folder](https://drive.google.com/drive/folders/1Vitm-praILoZvS5oDnv6yxtsW7pLSBtq) and put it somewhere (`SteamFolder/steamapps/sourcemods/<ProjectName>` for example)

4. Launch Hammer++ and configure it (Tools -> Options) as on the picture below

![Hammer configuration](https://github.com/user-attachments/assets/cb96c4f5-4fda-430e-8b21-fec7b8399a58)
...
- `mdl2obj` - Path to [MDL2OBJ](https://github.com/H2xDev/GodotVMF/tree/master/mdl2obj) utility. Used in case you need to move models from the mod's folder. Required in case of `models.import` is `true`.
